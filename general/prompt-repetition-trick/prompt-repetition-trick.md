...
![论文封面](./images/01-paper-cover.png)
...
![测试模型列表](./images/02-models-tested.png)
...
![测试方法图示](./images/03-nameindex-match.png)
...
![重复提示词对比](./images/04-prompt-repetition.png)
...
![DeepSeek R1 推理示例](./images/05-deepseek-r1.png)
