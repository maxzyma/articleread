...
![零Skill Agent概念图](https://cdn.jsdelivr.net/gh/maxzyma/articleread/zero-skill-agent/images/image_01.png)
...
![Demo示例 - 用户任务需求](https://cdn.jsdelivr.net/gh/maxzyma/articleread/zero-skill-agent/images/image_02.png)

然后Agent开始做分析、规划任务，挑选可能会用到的工具。

![Agent分析和规划工具](https://cdn.jsdelivr.net/gh/maxzyma/articleread/zero-skill-agent/images/image_03.png)
