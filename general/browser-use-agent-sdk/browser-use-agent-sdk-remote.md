...
![Browser Use 作者在 X 上分享](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/browser-use-agent-sdk/images/image_cover.jpg)
...
![Browser Use 作者在 X 上的发言](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/browser-use-agent-sdk/images/image_1.png)
...
![传统思路 vs 逆向思维对比](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/browser-use-agent-sdk/images/image_2.png)

逆向思维是，反过来，**直接把 Chrome DevTools Protocol (CDP) 的底层权限给 AI。**

![Chrome DevTools Protocol 底层权限](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/browser-use-agent-sdk/images/image_3.png)
...
![强制结束机制示例代码](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/browser-use-agent-sdk/images/image_4.png)
