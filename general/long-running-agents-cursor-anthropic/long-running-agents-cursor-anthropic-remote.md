...
![从 Solid 迁移到 React 的代码合并请求](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/long-running-agents-cursor-anthropic/images/img-3.png)
...
![Cursor CEO Michael Truell 的回应](https://cdn.jsdelivr.net/gh/maxzyma/articleread/general/long-running-agents-cursor-anthropic/images/img-6.png)
